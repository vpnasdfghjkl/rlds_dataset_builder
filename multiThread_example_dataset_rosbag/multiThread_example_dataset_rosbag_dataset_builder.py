...
def use_rosbag_to_show(bag_name):
    ...
    print("all length==============>:img_stamp,aligned_cmd_joint,aligned_state_joint,aligned_cmd_eef_pose,aligned_state_eef_pose,aligned_cmd_hand,aligned_state_hand")
    ...
    def _parse_example(episode_path,jump_index):
            ...
            for i, (img01, state, action) in enumerate(grouped_data):
                episode.append({
                    ...
                    'language_instruction': 'Pick up the orange and place it in the yellow plate.',
                })
...
class shenzhen5(MultiThreadedDatasetBuilder):
    ...
    N_WORKERS =21            # number of parallel workers for data conversion
    ...
    def _split_paths(self):
        ...
        train_folder=glob.glob("/home/lab/hx/rosbag_wrc_pick2plant/pick_up_something_*.bag")
