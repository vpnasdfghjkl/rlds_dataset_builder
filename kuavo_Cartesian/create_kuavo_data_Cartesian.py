...
target_dir=f"{dataset_dir}/data3"
...
os.makedirs(f'{dataset_dir}/data3/train', exist_ok=True)
os.makedirs(f'{dataset_dir}/data3/val', exist_ok=True)

create_fake_episode(sorted(train_episodes_list),sorted(episodes_dir_list_new),train=True)
create_fake_episode(sorted(val_episodes_list),sorted(episodes_dir_list_new),train=False)
