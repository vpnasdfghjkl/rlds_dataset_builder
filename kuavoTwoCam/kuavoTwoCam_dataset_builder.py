...
class KuavoTwoCam(tfds.core.GeneratorBasedBuilder):
    ...
    def _split_generators(self, dl_manager: tfds.download.DownloadManager):
        """Define data splits."""
        return {
            'train': self._generate_examples(path='/media/rebot801/PortableSSD/data_npy/train/episode_*.npy'),
            'val': self._generate_examples(path='/media/rebot801/PortableSSD/data_npy/val/episode_*.npy'),
        }
